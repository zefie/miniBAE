...
FLUIDSYNTH_API int fluid_voice_is_playing(fluid_voice_t* voice);
  ...
  /** Returns TRUE if the voice is currently in the ON state (not yet released). */
FLUIDSYNTH_API int fluid_voice_is_on(fluid_voice_t* voice);

  /** Returns the MIDI velocity of the voice. */
FLUIDSYNTH_API int fluid_voice_get_actual_velocity(fluid_voice_t* voice);

  /** Returns the MIDI channel number (0-15) of this voice. */
FLUIDSYNTH_API int fluid_voice_get_channel_num(fluid_voice_t* voice);
