...
struct _fluid_voice_t
{
  ...
  /* portamento */
  int portamento_active;          /* is portamento pitch glide active? */
  fluid_real_t portamento_pitch_offset;  /* current pitch offset (cents) */
  fluid_real_t portamento_pitch_incr;    /* per-sample increment */
