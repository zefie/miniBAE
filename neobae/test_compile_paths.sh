...
for f in Makefile.gui Makefile Makefile.clang; do
    ...
    # XMF + Native DLS (No FluidLite)
    runtest make -f ${f} XMF_SUPPORT=1 NATIVE_DLS=1
    # XMF + Native DLS + FluidLite
